...
const GroupCards = ({ title, members, isPublic, id, image_url }) => {
  ...
  return (
    <div className="w-[24rem] h-[24rem] rounded-md shadow-md bg-[#c3d7ca] hover:bg-[#9bbaa7] hover:shadow-inner cursor-pointer gap-2 flex flex-col items-center relative p-3">
      ...
      <h5 className="text-xl">{members} members</h5>
